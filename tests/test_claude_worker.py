...
#
# CI sets FRANKENSTEIN_REQUIRE_SANDBOX=1 and enables the namespaces at the
# runner, so containment is actually EXERCISED there; a runner that cannot
# sandbox fails loudly instead of quietly skipping the coverage.
